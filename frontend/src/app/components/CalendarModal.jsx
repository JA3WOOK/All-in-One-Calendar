 ...
 * @param {Array} props.schedules - 일정 배열
...
export function CalendarModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* 모달 컨텐츠 */}
      <div className="relative bg-white rounded-xl border border-slate-200 w-full max-w-6xl max-h-[90vh] overflow-hidden shadow-xl">
        {/* 헤더 */}
        <div className="bg-white border-b border-slate-200 px-8 py-5">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-slate-500 mt-1 text-base font-light">2026년 4월</p>
            </div>
            <button
              onClick={onClose}
        ...
        {/* 컨텐츠 */}
        <div className="overflow-y-auto max-h-[calc(90vh-96px)] p-8 bg-slate-50">
