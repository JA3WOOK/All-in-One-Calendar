                        ...
                        <>
                            ...
                            <Row icon={<LocationSVG />}>
                                <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
                                    {/* 기존 input 스타일에 cursor와 readOnly만 추가했습니다 */}
                                    <input
                                    ...
                                    />
                                    {/* 스타일 변수(SURFACE, BORDER 등)를 활용한 버튼입니다 */}
                                    <button
                                        type="button"
                                        onClick={handleAddressSearch}
                                        style={{
...
function RepeatOptions({ repeatType, setRepeatType, repeatInterval, setRepeatInterval, repeatEndAt, setRepeatEndAt, minDate }) {
    return (
        <div style={{
            marginTop: 10, background: SURFACE, borderRadius: 8, padding: "12px 14px",
